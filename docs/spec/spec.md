> **版本**：1.0.0 | **状态**：draft | **更新时间**：2026-04-18
>
...
- 粘贴会议文字 → AI 自动提取客户需求、跟进阶段、待办 Action，一键存入档案
- 所有人打开首页就能看到所有客户的跟进状态和未完成事项
- Action 有截止日期、负责人，勾选完成即标记
- 解析结果可手动修改，AI 辅助但不替代人工判断
...
> 打开应用的默认页面，看到所有客户的跟进状态、待办 Action 和快捷入口。
...
> 左侧粘贴会议文字，右侧预览 AI 解析结果，确认后写入跟进记录。
...
> 点击客户卡片进入，查看该客户的完整档案：基本信息、提取的需求、历次跟进记录、待办 Action。
